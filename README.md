...
설계 문서는 `docs/` 참조: `phase7_design.md`(멀티에이전트), `phase8_ops.md`(운영), `news_fed_index.md`(News+Fed 통합), `fed_weights.md`(통합 가중치 근거), `signal_design.md`(신호 설계), `phase6_signals.md`, `phase4_index.md`, `phase5_comparison.md`, `gpu_server.md`(GPU 서버), `ta_feedback_2026-08.md`(조교 피드백 반영 — 신호 게이트·Fed 축 확정판).
