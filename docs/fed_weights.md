...
> **수치 갱신(2026-09-06)**: T=1 엔진 기준. 문서에 T=3.1 시절 값
> (-0.436 / -0.386 / **-0.534** / -0.519 / -0.494)이 남아 있었다.
> 순서·결론 불변 — `docs/headline_norm_issue.md` 참조.
...
정석이고, 실제로도 50:50 이 홀드아웃까지 통과하며 최고 성능(-0.524)을 냈다.
